...
void Pipeline::record()
{
    ...
    m_pFileSink->conv1 = gst_element_factory_make ("videoconvert", "videoconvert");
    ...
    gst_element_link_many (m_pFileSink->queue, m_pFileSink->conv1, m_pFileSink->enc, m_pFileSink->sink, NULL);
